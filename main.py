...
def main():
    ...
    nx.draw_networkx(G, pos = nx.nx_agraph.graphviz_layout(G, prog='dot'), arrowsize=4, with_labels=True, ax=fig.add_subplot(), font_size=8, node_size=node_sizes, width=0.25, edge_color="#B85042", node_color="#E7E8D1")#, text_color="A7BEAE")
    if True: 
        # Save plot to file
        plt.use("Agg") 
        fig.savefig("graph_dot_2.png")
    else:
